...
<h1>React API Weather app</h1>
 <h3>In this app I am going to use an Open API to fetch weather data and display it to the DOM using react.js<br><br>
  <ul> Technologies <br><br>
    <li>Node.js - npm for installing and running dependancies</li>
    <li>React.js - create-react-app</li>
    <li>Use openweathermap.org API to fetch data about a given city</li>
